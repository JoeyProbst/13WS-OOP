...
private:
	...
	cItem* Anthill;//Pointer auf AntHill
protected:
...
public:
	...
	cItem* setAntHill(int z, int sp);	//Joey: Initialisiert den Ameisenhaufen auf dem Array_ofFieldptrs - d.h. diese Methode ruft den Creator auf um ihn zu erzeugen und positioniert den Ameisenhaufen dann auf einem der Fields des Arrays. 
